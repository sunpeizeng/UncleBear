...
public class IAPDemo : MonoBehaviour, IStoreListener
{
	...
	public void Awake()
	{
		...
		builder.Configure<IGooglePlayConfiguration>().SetPublicKey("");
		...
		builder.AddProduct("意大利美食礼包", ProductType.Consumable, new IDs
		{
			{"com.biemore.android.restaurant", GooglePlay.Name},
		});

Shader "Triniti/Particle/AB_COL_DO_FADE_P2_Dissolve_Particle_VertColorSequency"
{
	Properties
	{
	...
	Category
	{
		...
		BindChannels
		{
			...
			fixed4 frag (v2f i) : COLOR 
			{
				...
				float alpha_temp = i.col.a + 0.4;

				float Diff = alpha - _AlphaValue - 1 + alpha_temp * alpha_temp;
